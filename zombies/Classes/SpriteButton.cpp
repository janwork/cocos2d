...
bool SpriteButton::getZoomInOnHighlight() const
{
...
bool SpriteButton::getEnable() const
{
	return m_bEnable;
}


void SpriteButton::setColor(const Color3B & color)
{
	m_tColor = color;
...
const Color3B&  SpriteButton::getColor() const
{
	return m_tColor;
}
...
bool SpriteButton::isOpacityModifyRGB() const
{
...
Color3B SpriteButton::getUnableColor() const
{
...
bool SpriteButton::isCascadeOpacityEnabled() const
{
	return true;
}

bool SpriteButton::isCascadeColorEnabled() const
{
	return true;
}

const Color3B& SpriteButton::getDisplayedColor() const
{
	return m_tColor;
}

GLubyte SpriteButton::getDisplayedOpacity() const
{
	return m_cOpacity; 
}

void SpriteButton::updateDisplayedColor(const Color3B& parentColor)
{
	
}

void SpriteButton::updateDisplayedOpacity(GLubyte parentOpacity)
{

}

void SpriteButton::setCascadeColorEnabled(bool cascadeColorEnabled)
{

}

void SpriteButton::setCascadeOpacityEnabled(bool cascadeOpacityEnabled)
{
